      ...
      listItems: [
        {
          ...
          value: '',
          description:
            'All apps except merchant custom apps will fetch access tokens via token exchange. This assumes the app has declared scopes for Shopify managed installations.' +

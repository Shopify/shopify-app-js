...
describe('Refund resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/orders/450789469/refunds.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    queueMockResponse(JSON.stringify({"refund": {"id": 929361467, "order_id": 450789469, "created_at": "2024-07-02T09:01:05-05:00", "note": null, "user_id": null, "processed_at": "2024-07-02T09:01:05-05:00", "restock": false, "duties": [], "total_duties_set": {"shop_money": {"amount": "0.00", "currency_code": "USD"}, "presentment_money": {"amount": "0.00", "currency_code": "USD"}}, "additional_fees": [], "total_additional_fees_set": {"shop_money": {"amount": "0.00", "currency_code": "USD"}, "presentment_money": {"amount": "0.00", "currency_code": "USD"}}, "return": null, "admin_graphql_api_id": "gid://shopify/Refund/929361467", "refund_line_items": [], "transactions": [{"id": 1068278484, "order_id": 450789469, "kind": "refund", "gateway": "bogus", "status": "success", "message": "Bogus Gateway: Forced success", "created_at": "2024-07-02T09:01:05-05:00", "test": true, "authorization": null, "location_id": null, "user_id": null, "parent_id": 801038806, "processed_at": "2024-07-02T09:01:05-05:00", "device_id": null, "error_code": null, "source_name": "755357713", "receipt": {}, "amount": "5.00", "currency": "USD", "payment_id": "c901414060.1", "total_unsettled_set": {"presentment_money": {"amount": "348.0", "currency": "USD"}, "shop_money": {"amount": "348.0", "currency": "USD"}}, "manual_payment_gateway": false, "admin_graphql_api_id": "gid://shopify/OrderTransaction/1068278484"}], "order_adjustments": [{"id": 1030976842, "order_id": 450789469, "refund_id": 929361467, "amount": "-5.00", "tax_amount": "0.00", "kind": "shipping_refund", "reason": "Shipping refund", "amount_set": {"shop_money": {"amount": "-5.00", "currency_code": "USD"}, "presentment_money": {"amount": "-5.00", "currency_code": "USD"}}, "tax_amount_set": {"shop_money": {"amount": "0.00", "currency_code": "USD"}, "presentment_money": {"amount": "0.00", "currency_code": "USD"}}}]}}));
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/orders/450789469/refunds/509562969.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-07/orders/450789469/refunds/calculate.json',
      query: '',
      headers,

...
describe('MarketingEvent resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/marketing_events.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/marketing_events/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/marketing_events/998730532.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    queueMockResponse(JSON.stringify({"engagements": [{"occurred_on": "2024-07-15", "fetched_at": null, "views_count": 0, "impressions_count": null, "clicks_count": 0, "favorites_count": 0, "comments_count": null, "shares_count": null, "ad_spend": "10.0", "currency_code": null, "is_cumulative": true, "unsubscribes_count": null, "complaints_count": null, "fails_count": null, "sends_count": null, "unique_views_count": null, "unique_clicks_count": null, "utc_offset": null}, {"occurred_on": "2024-07-16", "fetched_at": null, "views_count": 100, "impressions_count": null, "clicks_count": 50, "favorites_count": null, "comments_count": null, "shares_count": null, "ad_spend": null, "currency_code": null, "is_cumulative": true, "unsubscribes_count": null, "complaints_count": null, "fails_count": null, "sends_count": null, "unique_views_count": null, "unique_clicks_count": null, "utc_offset": null}, {"occurred_on": "2024-07-17", "fetched_at": null, "views_count": 200, "impressions_count": null, "clicks_count": 100, "favorites_count": null, "comments_count": null, "shares_count": null, "ad_spend": null, "currency_code": null, "is_cumulative": true, "unsubscribes_count": null, "complaints_count": null, "fails_count": null, "sends_count": null, "unique_views_count": null, "unique_clicks_count": null, "utc_offset": null}]}));

    const marketing_event = new shopify.rest.MarketingEvent({session: session});
    marketing_event.id = 998730532;
    await marketing_event.engagements({
      body: {"engagements": [{"occurred_on": "2024-07-15", "views_count": 0, "clicks_count": 0, "favorites_count": 0, "ad_spend": 10.0, "is_cumulative": true}, {"occurred_on": "2024-07-16", "views_count": 100, "clicks_count": 50, "is_cumulative": true}, {"occurred_on": "2024-07-17", "views_count": 200, "clicks_count": 100, "is_cumulative": true}]},
    });

    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-07/marketing_events/998730532/engagements.json',
      query: '',
      headers,
      data: {"engagements": [{"occurred_on": "2024-07-15", "views_count": 0, "clicks_count": 0, "favorites_count": 0, "ad_spend": 10.0, "is_cumulative": true}, {"occurred_on": "2024-07-16", "views_count": 100, "clicks_count": 50, "is_cumulative": true}, {"occurred_on": "2024-07-17", "views_count": 200, "clicks_count": 100, "is_cumulative": true}]}
    }).toMatchMadeHttpRequest();
  });

...
describe('FulfillmentRequest resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-07/fulfillment_orders/1046000778/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-07/fulfillment_orders/1046000779/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-07/fulfillment_orders/1046000781/fulfillment_request/accept.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-07/fulfillment_orders/1046000777/fulfillment_request/reject.json',
      query: '',
      headers,

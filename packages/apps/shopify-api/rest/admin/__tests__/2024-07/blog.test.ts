...
describe('Blog resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/blogs.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_2', async () => {
    ...
    queueMockResponse(JSON.stringify({"blogs": [{"id": 382285388, "handle": "banana-blog", "title": "A Gnu Blog", "updated_at": "2006-02-02T19:00:00-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2024-07-02T08:59:11-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/382285388"}, {"id": 1008414253, "handle": "apple-main-blog", "title": "Apple main blog", "updated_at": "2024-07-02T09:12:00-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2024-07-02T09:12:00-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/1008414253"}]}));
  ...
  it('test_3', async () => {
    ...
    queueMockResponse(JSON.stringify({"blog": {"id": 1008414249, "handle": "apple-main-blog", "title": "Apple main blog", "updated_at": "2024-07-02T09:11:50-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2024-07-02T09:11:50-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/1008414249"}}));
  ...
  it('test_4', async () => {
    ...
    queueMockResponse(JSON.stringify({"blog": {"id": 1008414248, "handle": "apple-main-blog", "title": "Apple main blog", "updated_at": "2024-07-02T09:11:48-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2024-07-02T09:11:48-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/1008414248"}}));
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/blogs/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-07/blogs/241253187.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_9', async () => {
    ...
    queueMockResponse(JSON.stringify({"blog": {"title": "IPod Updates", "handle": "apple-blog", "id": 241253187, "updated_at": "2024-07-02T09:11:50-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2024-07-02T08:59:11-05:00", "template_suffix": null, "tags": "Announcing, Mystery", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/241253187"}}));
  ...
  it('test_10', async () => {
    ...
    queueMockResponse(JSON.stringify({"blog": {"title": "IPod Updates", "handle": "ipod-updates", "commentable": "moderate", "id": 241253187, "updated_at": "2024-07-02T09:12:01-05:00", "feedburner": null, "feedburner_location": null, "created_at": "2024-07-02T08:59:11-05:00", "template_suffix": null, "tags": "Announcing, Mystery", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/241253187"}}));

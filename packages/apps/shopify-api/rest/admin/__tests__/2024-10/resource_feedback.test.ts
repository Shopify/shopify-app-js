...
describe('ResourceFeedback resource', () => {
  ...
  it('test_1', async () => {
    ...
    resource_feedback.feedback_generated_at = "2024-10-02T22:14:15.870447Z";
    await resource_feedback.save({});

    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/resource_feedback.json',
      query: '',
      headers,
      data: { "resource_feedback": {"state": "requires_action", "messages": ["is not connected. Connect your account to use this sales channel."], "feedback_generated_at": "2024-10-02T22:14:15.870447Z"} }
  ...
  it('test_2', async () => {
    ...
    resource_feedback.feedback_generated_at = "2024-10-02T22:14:14.748024Z";
    await resource_feedback.save({});
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "resource_feedback": {"state": "success", "feedback_generated_at": "2024-10-02T22:14:14.748024Z"} }
    }).toMatchMadeHttpRequest();
  });

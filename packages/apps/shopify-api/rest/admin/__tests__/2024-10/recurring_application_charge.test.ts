...
describe('RecurringApplicationCharge resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/recurring_application_charges.json',
      query: '',
      headers,
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/recurring_application_charges/455696195.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-10/recurring_application_charges/455696195/customize.json',

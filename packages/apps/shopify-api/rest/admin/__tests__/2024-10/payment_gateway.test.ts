...
describe('PaymentGateway resource', () => {
  ...
  it('test_1', async () => {
    ...
    queueMockResponse(JSON.stringify({"payment_gateways": [{"disabled": true, "id": 170508070, "name": "Cash on Delivery (COD)", "provider_id": 140, "sandbox": false, "supports_network_tokenization": null, "type": "ManualPaymentGateway", "enabled_card_brands": [], "processing_method": "manual", "service_name": "Cash on Delivery (COD)", "metadata": {}, "created_at": "2024-10-02T08:59:11-05:00", "updated_at": "2024-10-02T08:59:11-05:00"}, {"disabled": false, "id": 431363653, "name": "shopify_payments", "provider_id": 87, "sandbox": false, "supports_network_tokenization": null, "type": "DirectPaymentGateway", "enabled_card_brands": ["visa", "master", "american_express", "discover", "diners_club"], "processing_method": "direct", "service_name": "Shopify Payments", "metadata": {"google_pay_merchant_id": 548380009}, "created_at": "2011-12-31T19:00:00-05:00", "updated_at": "2024-10-02T09:02:13-05:00", "credential4": null, "attachment": null}]}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/payment_gateways.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/payment_gateways/431363653.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    queueMockResponse(JSON.stringify({"payment_gateway": {"disabled": false, "id": 170508070, "name": "Cash on Delivery (COD)", "provider_id": 140, "sandbox": true, "supports_network_tokenization": null, "type": "ManualPaymentGateway", "enabled_card_brands": [], "processing_method": "manual", "service_name": "Cash on Delivery (COD)", "metadata": {}, "created_at": "2024-10-02T08:59:11-05:00", "updated_at": "2024-10-02T09:02:13-05:00"}}));
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-10/payment_gateways/170508070.json',
      query: '',
      headers,

...
describe('CancellationRequest resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/fulfillment_orders/1046000839/cancellation_request.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/fulfillment_orders/1046000840/cancellation_request/accept.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/fulfillment_orders/1046000838/cancellation_request/reject.json',
      query: '',
      headers,

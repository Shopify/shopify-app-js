...
describe('Comment resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/comments.json',
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/comments/count.json',
      query: 'article_id=134645308&blog_id=241253187',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/comments/118373535.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_9', async () => {
    ...
    comment.published_at = "2024-10-02T14:00:35.255Z";
    await comment.save({});
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "comment": {"body": "You can even update through a web service.", "author": "Your new name", "email": "your@updated-email.com", "published_at": "2024-10-02T14:00:35.255Z"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_11', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/comments/653537639/spam.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/comments/653537639/not_spam.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_13', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/comments/653537639/approve.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_14', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/comments/653537639/remove.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/comments/653537639/restore.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

...
describe('Redirect resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/redirects.json',
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/redirects/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/redirects/668809255.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-10/redirects/950115854.json',
      query: '',
      headers,

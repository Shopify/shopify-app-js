...
describe('DiscountCode resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/price_rules/507328175/discount_codes.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-10/price_rules/507328175/discount_codes/507328175.json',
      query: '',
      headers,
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/discount_codes/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/price_rules/507328175/batch.json',
      query: '',
      headers,
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/price_rules/507328175/batch/173232803.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/price_rules/507328175/batch/173232803/discount_codes.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

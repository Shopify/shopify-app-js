...
describe('ApplePayCertificate resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/apple_pay_certificates.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/apple_pay_certificates/1068938274.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-10/apple_pay_certificates/1068938276.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2024-10/apple_pay_certificates/1068938275.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/apple_pay_certificates/1068938277/csr.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

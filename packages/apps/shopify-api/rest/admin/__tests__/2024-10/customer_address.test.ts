...
describe('CustomerAddress resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/customers/207119551/addresses.json',
      query: 'limit=1',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/customers/207119551/addresses/207119551.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2024-10/customers/207119551/addresses/1053317322.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-10/customers/207119551/addresses/set.json',
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-10/customers/207119551/addresses/1053317320/default.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

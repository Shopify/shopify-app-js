...
describe('ProductResourceFeedback resource', () => {
  ...
  it('test_1', async () => {
    ...
    product_resource_feedback.resource_updated_at = "2024-10-02T17:13:35-05:00";
    product_resource_feedback.feedback_generated_at = "2024-10-02T22:14:47.628840Z";
    await product_resource_feedback.save({});

    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/products/632910392/resource_feedback.json',
      query: '',
      headers,
      data: { "resource_feedback": {"state": "requires_action", "messages": ["Needs at least one image."], "resource_updated_at": "2024-10-02T17:13:35-05:00", "feedback_generated_at": "2024-10-02T22:14:47.628840Z"} }
  ...
  it('test_2', async () => {
    ...
    product_resource_feedback.resource_updated_at = "2024-10-02T17:13:35-05:00";
    product_resource_feedback.feedback_generated_at = "2024-10-02T22:14:40.429446Z";
    await product_resource_feedback.save({});
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "resource_feedback": {"state": "success", "resource_updated_at": "2024-10-02T17:13:35-05:00", "feedback_generated_at": "2024-10-02T22:14:40.429446Z"} }
    }).toMatchMadeHttpRequest();
  });

...
describe('Fulfillment resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/orders/450789469/fulfillments.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/fulfillment_orders/1046000799/fulfillments.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/orders/450789469/fulfillments/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/orders/450789469/fulfillments/255858046.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    queueMockResponse(JSON.stringify({"fulfillment": {"id": 1069019867, "order_id": 450789469, "status": "success", "created_at": "2024-10-02T09:01:37-05:00", "service": "manual", "updated_at": "2024-10-02T09:01:37-05:00", "tracking_company": null, "shipment_status": null, "location_id": 24826418, "line_items": [{"id": 1071823175, "variant_id": 389013007, "title": "Crafty Shoes - Red", "quantity": 1, "sku": "crappy_shoes_red", "variant_title": "Small", "vendor": null, "fulfillment_service": "manual", "product_id": 910489600, "requires_shipping": true, "taxable": true, "gift_card": false, "name": "Crafty Shoes - Red - Small", "variant_inventory_management": null, "properties": [], "product_exists": true, "fulfillable_quantity": 0, "grams": 0, "price": "10.00", "total_discount": "0.00", "fulfillment_status": "fulfilled", "price_set": {"shop_money": {"amount": "10.00", "currency_code": "USD"}, "presentment_money": {"amount": "10.00", "currency_code": "USD"}}, "total_discount_set": {"shop_money": {"amount": "0.00", "currency_code": "USD"}, "presentment_money": {"amount": "0.00", "currency_code": "USD"}}, "discount_allocations": [], "duties": [], "admin_graphql_api_id": "gid://shopify/LineItem/1071823175", "tax_lines": []}], "tracking_number": "MS1562678", "tracking_numbers": ["MS1562678"], "tracking_url": "https://www.my-shipping-company.com?tracking=MS1562678", "tracking_urls": ["https://www.my-shipping-company.com?tracking=MS1562678"], "receipt": {}, "name": "#1001.2", "admin_graphql_api_id": "gid://shopify/Fulfillment/1069019867"}}));
  ...
  it('test_11', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/fulfillments/1069019869/update_tracking.json',
      query: '',
      headers,
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/fulfillments/1069019864/update_tracking.json',
      query: '',
      headers,
  ...
  it('test_13', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/fulfillments/1069019871/cancel.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

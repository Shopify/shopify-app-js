...
describe('UsageCharge resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-10/recurring_application_charges/455696195/usage_charges.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-10/recurring_application_charges/455696195/usage_charges/1034618211.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

...
describe('Collection resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-10/collections/841564295.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-10/collections/841564295/products.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

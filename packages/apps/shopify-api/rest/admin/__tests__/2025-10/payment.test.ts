...
describe('Payment resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-10/checkouts/7yjf4v2we7gamku6a6h7tvm8h3mmvs4x/payments.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-10/checkouts/7yjf4v2we7gamku6a6h7tvm8h3mmvs4x/payments/25428999.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

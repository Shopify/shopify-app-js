...
describe('Customer resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/customers.json',
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/customers/search.json',
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/customers/207119551.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_22', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-07/customers/207119551/account_activation_url.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_23', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-07/customers/207119551/send_invite.json',
      query: '',
      headers,
  ...
  it('test_25', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/customers/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_28', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/customers/207119551/orders.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

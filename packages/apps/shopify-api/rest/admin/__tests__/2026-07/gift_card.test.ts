...
describe('GiftCard resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/gift_cards.json',
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/gift_cards/1035197676.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/gift_cards/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_11', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-07/gift_cards/1035197676/disable.json',
      query: '',
      headers,
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-07/gift_cards/search.json',

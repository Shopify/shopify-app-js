...
describe('Location resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/locations.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_2', async () => {
    ...
    queueMockResponse(JSON.stringify({"location": {"id": 487838322, "name": "Fifth Avenue AppleStore", "address1": null, "address2": null, "city": null, "zip": null, "province": null, "country": "US", "phone": null, "created_at": "2025-01-02T11:09:43-05:00", "updated_at": "2025-01-02T11:09:43-05:00", "country_code": "US", "country_name": "United States", "province_code": null, "legacy": false, "active": true, "admin_graphql_api_id": "gid://shopify/Location/487838322"}}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/locations/487838322.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/locations/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/locations/487838322/inventory_levels.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

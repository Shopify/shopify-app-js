...
describe('ProductListing resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/product_listings.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/product_listings/product_ids.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/product_listings/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    queueMockResponse(JSON.stringify({"product_listing": {"product_id": 921728736, "created_at": "2025-01-02T11:09:43-05:00", "updated_at": "2025-01-02T11:09:43-05:00", "body_html": "<p>The iPod Touch has the iPhone's multi-touch interface, with a physical home button off the touch screen. The home screen has a list of buttons for the available applications.</p>", "handle": "ipod-touch", "product_type": "Cult Products", "title": "IPod Touch 8GB", "vendor": "Apple", "available": true, "tags": "", "published_at": "2017-08-31T20:00:00-04:00", "variants": [{"id": 447654529, "title": "Black", "option_values": [{"option_id": 891236591, "name": "Title", "value": "Black"}], "price": "199.00", "formatted_price": "$199.00", "compare_at_price": null, "grams": 567, "requires_shipping": true, "sku": "IPOD2009BLACK", "barcode": "1234_black", "taxable": true, "position": 1, "available": true, "inventory_policy": "continue", "inventory_quantity": 13, "inventory_management": "shopify", "fulfillment_service": "manual", "weight": 1.25, "weight_unit": "lb", "image_id": null, "created_at": "2025-01-02T11:09:43-05:00", "updated_at": "2025-01-02T11:09:43-05:00"}], "images": [], "options": [{"id": 891236591, "name": "Title", "product_id": 921728736, "position": 1, "values": ["Black"]}]}}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/product_listings/921728736.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

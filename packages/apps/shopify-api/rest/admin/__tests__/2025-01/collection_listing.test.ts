...
describe('CollectionListing resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/collection_listings.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/collection_listings/841564295/product_ids.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    queueMockResponse(JSON.stringify({"collection_listing": {"collection_id": 482865238, "updated_at": "2025-01-02T11:09:43-05:00", "body_html": "<p>The best selling ipod ever</p>", "default_product_image": null, "handle": "smart-ipods", "image": {"created_at": "2025-01-02T11:09:43-05:00", "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1735834183"}, "title": "Smart iPods", "sort_order": "manual", "published_at": "2017-08-31T20:00:00-04:00"}}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/collection_listings/482865238.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2025-01/collection_listings/841564295.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

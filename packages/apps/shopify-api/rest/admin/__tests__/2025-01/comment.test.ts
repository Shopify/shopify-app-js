...
describe('Comment resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/comments.json',
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/comments/count.json',
      query: 'article_id=134645308&blog_id=241253187',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/comments/118373535.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_9', async () => {
    ...
    queueMockResponse(JSON.stringify({"comment": {"author": "Your new name", "body": "You can even update through a web service.", "email": "your@updated-email.com", "published_at": "2025-01-02T11:22:10-05:00", "id": 118373535, "body_html": "<p>You can even update through a web service.</p>", "status": "published", "article_id": 134645308, "blog_id": 241253187, "created_at": "2025-01-02T11:09:43-05:00", "updated_at": "2025-01-02T11:22:11-05:00", "ip": "127.0.0.1", "user_agent": "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_4; en-us) AppleWebKit/525.18 (KHTML, like Gecko) Version/3.1.2 Safari/525.20.1"}}));
    ...
    comment.published_at = "2025-01-02T16:22:10.772Z";
    await comment.save({});
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "comment": {"body": "You can even update through a web service.", "author": "Your new name", "email": "your@updated-email.com", "published_at": "2025-01-02T16:22:10.772Z"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_10', async () => {
    ...
    queueMockResponse(JSON.stringify({"comment": {"id": 757536351, "body": "I like comments\nAnd I like posting them *RESTfully*.", "body_html": "<p>I like comments<br>\nAnd I like posting them <strong>RESTfully</strong>.</p>", "author": "Your name", "email": "your@email.com", "status": "pending", "article_id": 134645308, "blog_id": 241253187, "created_at": "2025-01-02T11:22:08-05:00", "updated_at": "2025-01-02T11:22:08-05:00", "ip": "107.20.160.121", "user_agent": null, "published_at": null}}));
  ...
  it('test_11', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-01/comments/653537639/spam.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-01/comments/653537639/not_spam.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_13', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-01/comments/653537639/approve.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_14', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-01/comments/653537639/remove.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-01/comments/653537639/restore.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

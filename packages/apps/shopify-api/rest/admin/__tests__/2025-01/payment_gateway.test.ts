...
describe('PaymentGateway resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/payment_gateways.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/payment_gateways/431363653.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    queueMockResponse(JSON.stringify({"payment_gateway": {"disabled": false, "id": 170508070, "name": "Cash on Delivery (COD)", "provider_id": 140, "sandbox": true, "supports_network_tokenization": null, "type": "ManualPaymentGateway", "enabled_card_brands": [], "processing_method": "manual", "service_name": "Cash on Delivery (COD)", "metadata": {}, "created_at": "2025-01-02T11:09:43-05:00", "updated_at": "2025-01-02T11:20:25-05:00"}}));
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-01/payment_gateways/170508070.json',
      query: '',
      headers,

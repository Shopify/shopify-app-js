...
describe('Asset resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/themes/828155753/assets.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_2', async () => {
    ...
    queueMockResponse(JSON.stringify({"asset": {"key": "templates/index.liquid", "public_url": null, "created_at": "2010-07-12T15:31:50-04:00", "updated_at": "2025-01-02T11:21:30-05:00", "content_type": "application/x-liquid", "size": 110, "checksum": "cd71db2e14df976c8aa44b44c8dae77b", "theme_id": 828155753}}));
  ...
  it('test_5', async () => {
    ...
    queueMockResponse(JSON.stringify({"asset": {"key": "layout/alternate.liquid", "public_url": null, "created_at": "2025-01-02T11:21:30-05:00", "updated_at": "2025-01-02T11:21:30-05:00", "content_type": "application/x-liquid", "size": 3049, "checksum": "1879a06996941b2ff1ff485a1fe60a97", "theme_id": 828155753}}));

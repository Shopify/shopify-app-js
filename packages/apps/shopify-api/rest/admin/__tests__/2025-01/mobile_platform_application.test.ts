...
describe('MobilePlatformApplication resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/mobile_platform_applications.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/mobile_platform_applications/1066175997.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    mobile_platform_application.platform = "android";
    mobile_platform_application.created_at = "2025-01-02T11:11:09-05:00";
    mobile_platform_application.updated_at = "2025-01-02T11:11:09-05:00";
    mobile_platform_application.sha256_cert_fingerprints = [
      "14:6D:E9:83:C5:73:06:50:D8:EE:B9:95:2F:34:FC:64:16:A0:83:42:E6:1D:BE:A8:8A:04:96:B2:3F:CF:44:E5"
    ];
    mobile_platform_application.enabled_universal_or_app_links = true;
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-01/mobile_platform_applications/1066175998.json',
      query: '',
      headers,
      data: { "mobile_platform_application": {"application_id": "com.example.news.app", "platform": "android", "created_at": "2025-01-02T11:11:09-05:00", "updated_at": "2025-01-02T11:11:09-05:00", "sha256_cert_fingerprints": ["14:6D:E9:83:C5:73:06:50:D8:EE:B9:95:2F:34:FC:64:16:A0:83:42:E6:1D:BE:A8:8A:04:96:B2:3F:CF:44:E5"], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": false, "enabled_app_clips": false, "app_clip_application_id": null} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_6', async () => {
    ...
    mobile_platform_application.platform = "ios";
    mobile_platform_application.created_at = "2025-01-02T11:11:08-05:00";
    mobile_platform_application.updated_at = "2025-01-02T11:11:08-05:00";
    mobile_platform_application.sha256_cert_fingerprints = [];
    mobile_platform_application.enabled_universal_or_app_links = true;
    mobile_platform_application.enabled_shared_webcredentials = true;
    mobile_platform_application.enabled_app_clips = false;
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-01/mobile_platform_applications/1066175996.json',
      query: '',
      headers,
      data: { "mobile_platform_application": {"application_id": "A1B2.ca.domain.app", "platform": "ios", "created_at": "2025-01-02T11:11:08-05:00", "updated_at": "2025-01-02T11:11:08-05:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true, "enabled_app_clips": false, "app_clip_application_id": null} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2025-01/mobile_platform_applications/1066175999.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

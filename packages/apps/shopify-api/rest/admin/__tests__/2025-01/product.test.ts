...
describe('Product resource', () => {
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/products/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/products/632910392.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

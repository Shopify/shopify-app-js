...
describe('PriceRule resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-01/price_rules.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    queueMockResponse(JSON.stringify({"price_rule": {"id": 1057371196, "value_type": "percentage", "value": "-100.0", "customer_selection": "all", "target_type": "shipping_line", "target_selection": "all", "allocation_method": "each", "allocation_limit": null, "once_per_customer": false, "usage_limit": 20, "starts_at": "2017-01-19T12:59:10-05:00", "ends_at": null, "created_at": "2025-01-02T11:20:20-05:00", "updated_at": "2025-01-02T11:20:20-05:00", "entitled_product_ids": [], "entitled_variant_ids": [], "entitled_collection_ids": [], "entitled_country_ids": [], "prerequisite_product_ids": [], "prerequisite_variant_ids": [], "prerequisite_collection_ids": [], "customer_segment_prerequisite_ids": [], "prerequisite_customer_ids": [], "prerequisite_subtotal_range": {"greater_than_or_equal_to": "50.0"}, "prerequisite_quantity_range": null, "prerequisite_shipping_price_range": null, "prerequisite_to_entitlement_quantity_ratio": {"prerequisite_quantity": null, "entitled_quantity": null}, "prerequisite_to_entitlement_purchase": {"prerequisite_amount": null}, "title": "FREESHIPPING", "admin_graphql_api_id": "gid://shopify/PriceRule/1057371196"}}));
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-01/price_rules/507328175.json',
      query: '',
      headers,
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/price_rules/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

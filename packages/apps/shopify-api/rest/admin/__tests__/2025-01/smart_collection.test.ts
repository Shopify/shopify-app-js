...
describe('SmartCollection resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/smart_collections.json',
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/smart_collections/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/smart_collections/482865238.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_10', async () => {
    ...
    smart_collection.updated_at = "2025-01-02T11:37:11-05:00";
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "smart_collection": {"image": "", "updated_at": "2025-01-02T11:37:11-05:00", "handle": "smart-ipods", "title": "Smart iPods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_20', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-01/smart_collections/482865238/order.json',

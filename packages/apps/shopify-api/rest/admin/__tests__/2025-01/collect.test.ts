...
describe('Collect resource', () => {
  ...
  it('test_1', async () => {
    ...
    queueMockResponse(JSON.stringify({"collect": {"id": 1071559574, "collection_id": 841564295, "product_id": 921728736, "created_at": "2025-01-02T11:20:42-05:00", "updated_at": "2025-01-02T11:20:42-05:00", "position": 2, "sort_value": "0000000002"}}));
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-01/collects.json',
      query: '',
      headers,
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2025-01/collects/455204334.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-01/collects/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

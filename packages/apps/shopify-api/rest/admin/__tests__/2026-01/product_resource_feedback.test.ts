...
describe('ProductResourceFeedback resource', () => {
  ...
  it('test_1', async () => {
    ...
    product_resource_feedback.resource_updated_at = "2025-04-02T11:09:43-05:00";
    product_resource_feedback.feedback_generated_at = "2025-04-02T16:22:23.605756Z";
    await product_resource_feedback.save({});

    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/products/632910392/resource_feedback.json',
      query: '',
      headers,
      data: { "resource_feedback": {"state": "requires_action", "messages": ["Needs at least one image."], "resource_updated_at": "2025-04-02T11:09:43-05:00", "feedback_generated_at": "2025-04-02T16:22:23.605756Z"} }
  ...
  it('test_2', async () => {
    ...
    product_resource_feedback.resource_updated_at = "2025-04-02T11:09:43-05:00";
    product_resource_feedback.feedback_generated_at = "2025-04-02T16:22:23.139254Z";
    await product_resource_feedback.save({});
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "resource_feedback": {"state": "success", "resource_updated_at": "2025-04-02T11:09:43-05:00", "feedback_generated_at": "2025-04-02T16:22:23.139254Z"} }
    }).toMatchMadeHttpRequest();
  });

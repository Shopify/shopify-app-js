...
describe('Dispute resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/shopify_payments/disputes.json',
  ...
  it('test_4', async () => {
    ...
    queueMockResponse(JSON.stringify({"dispute": {"id": 598735659, "order_id": 625362839, "type": "chargeback", "amount": "11.50", "currency": "USD", "reason": "fraudulent", "network_reason_code": "4827", "status": "needs_response", "evidence_due_by": "2099-12-29T19:00:00-05:00", "evidence_sent_on": null, "finalized_on": null, "initiated_at": "2013-05-03T20:00:00-04:00"}}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/shopify_payments/disputes/598735659.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

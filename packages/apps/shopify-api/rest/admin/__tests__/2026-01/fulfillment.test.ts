...
describe('Fulfillment resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/orders/450789469/fulfillments.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000819/fulfillments.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/orders/450789469/fulfillments/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/orders/450789469/fulfillments/255858046.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillments.json',
      query: '',
      headers,
  ...
  it('test_11', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillments/1069019869/update_tracking.json',
      query: '',
      headers,
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillments/1069019866/update_tracking.json',
      query: '',
      headers,
  ...
  it('test_13', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillments/1069019879/cancel.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

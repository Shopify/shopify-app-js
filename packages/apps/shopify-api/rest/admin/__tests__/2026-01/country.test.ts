...
describe('Country resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/countries.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    queueMockResponse(JSON.stringify({"country": {"id": 980881734, "name": "France", "code": "FR", "tax_name": "TVA", "tax": 0.2, "provinces": []}}));
  ...
  it('test_4', async () => {
    ...
    queueMockResponse(JSON.stringify({"country": {"id": 980881733, "name": "France", "code": "FR", "tax_name": "TVA", "tax": 0.2, "provinces": []}}));
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/countries/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/countries/879921427.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

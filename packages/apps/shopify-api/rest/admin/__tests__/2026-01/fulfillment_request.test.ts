...
describe('FulfillmentRequest resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000806/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000807/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000809/fulfillment_request/accept.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000805/fulfillment_request/reject.json',
      query: '',
      headers,

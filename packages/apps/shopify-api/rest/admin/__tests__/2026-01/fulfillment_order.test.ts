...
describe('FulfillmentOrder resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/orders/450789469/fulfillment_orders.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000781.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000779.json',
      query: 'include_financial_summaries=true',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000790.json',
      query: 'include_order_reference_fields=true',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000788/cancel.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000793/close.json',
      query: '',
      headers,
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000786/move.json',
      query: '',
      headers,
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000785/open.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_11', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000791/reschedule.json',
      query: '',
      headers,
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000782/hold.json',
      query: '',
      headers,
  ...
  it('test_13', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/set_fulfillment_orders_deadline.json',
      query: '',
      headers,
  ...
  it('test_14', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/fulfillment_orders/1046000794/release_hold.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

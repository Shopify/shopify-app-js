...
describe('ResourceFeedback resource', () => {
  ...
  it('test_1', async () => {
    ...
    resource_feedback.feedback_generated_at = "2025-04-02T16:38:54.865459Z";
    await resource_feedback.save({});

    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2026-01/resource_feedback.json',
      query: '',
      headers,
      data: { "resource_feedback": {"state": "requires_action", "messages": ["is not connected. Connect your account to use this sales channel."], "feedback_generated_at": "2025-04-02T16:38:54.865459Z"} }
  ...
  it('test_2', async () => {
    ...
    resource_feedback.feedback_generated_at = "2025-04-02T16:38:54.358185Z";
    await resource_feedback.save({});
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "resource_feedback": {"state": "success", "feedback_generated_at": "2025-04-02T16:38:54.358185Z"} }
    }).toMatchMadeHttpRequest();
  });

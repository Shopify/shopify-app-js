...
describe('CustomCollection resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-04/custom_collections.json',
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-04/custom_collections/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-04/custom_collections/841564295.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

...
describe('PaymentGateway resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-04/payment_gateways.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-04/payment_gateways/431363653.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-04/payment_gateways/170508070.json',
      query: '',
      headers,

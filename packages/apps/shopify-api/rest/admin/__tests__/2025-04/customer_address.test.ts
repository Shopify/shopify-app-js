...
describe('CustomerAddress resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-04/customers/207119551/addresses.json',
      query: 'limit=1',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2025-04/customers/207119551/addresses/207119551.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2025-04/customers/207119551/addresses/1053317310.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-04/customers/207119551/addresses/set.json',
      query: 'address_ids%5B%5D=1053317311&operation=destroy',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2025-04/customers/207119551/addresses/1053317312/default.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();

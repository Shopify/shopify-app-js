...
describe('CancellationRequest resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-07/fulfillment_orders/1046000803/cancellation_request.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-07/fulfillment_orders/1046000804/cancellation_request/accept.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2025-07/fulfillment_orders/1046000802/cancellation_request/reject.json',
      query: '',
      headers,

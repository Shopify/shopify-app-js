  ...
  sections: [
    ...
    },
    {
      ...
      sectionContent:
        ...
        "\n\n If you wish to learn about scopes management and APIs, please read through [Manage access scopes](https://shopify.dev/docs/apps/build/authentication-authorization/app-installation/managing-access-scopes)" +        "\n\n > Note: Newly created Remix apps from the template after February 1st 2024 has this feature enabled by default." +

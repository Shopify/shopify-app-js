...
> extends Omit<
  ...
  /**
   * When set to `false`, embedded apps will fetch access tokens via [token exchange](https://shopify.dev/docs/apps/auth/get-access-tokens/token-exchange).
   ...
   *
   * When set to `true`, apps will fetch access tokens via [Authorization Code Grant](https://shopify.dev/docs/apps/auth/get-access-tokens/authorization-code-grant).
   *
   * @defaultValue `false`
   */
  disableTokenExchange?: boolean;

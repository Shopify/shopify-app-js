...
- f04f39c: Document refresh token support in README. Redis storage already supports refresh tokens through JSON serialization of the complete Session object.

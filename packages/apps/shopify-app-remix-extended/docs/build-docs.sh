COMPILE_DOCS="pnpm tsc --project docs/tsconfig.docs.json --types react --moduleResolution node  --target esNext  --module CommonJS && generate-docs --overridePath ./docs/typeOverride.json --input  ./src ../shopify-app-remix/src  --declarationPath ../shopify-api/dist/ts ../../../node_modules/@shopify/polaris/build/ts --output ./docs/generated && find . -name '*.doc.js' -delete && find ../shopify-app-remix -name '*.doc.js' -delete"
